...
\hline
	\multirow{2}*{$S_x$} & $\frac{\hbar}{2}$ & $ \ket{+}_x = \dfrac{1}{\sqrt{2}}\vettore{1\\  1}$\\[4ex]
%		\cline{2-3}
	& $-\frac{\hbar}{2}$ & $\ket{-}_x = \dfrac{1}{\sqrt{2}}\vettore{1\\ - 1}$\\[4ex]
\hline
	\multirow{2}*{$S_y$} & $\frac{\hbar}{2}$ & $ \ket{+}_y = \dfrac{1}{\sqrt{2}}\vettore{1\\ i}$\\[4ex]
%		\cline{2-3}
	& $-\frac{\hbar}{2}$ & $\ket{-}_y = \dfrac{1}{\sqrt{2}}\vettore{1\\ - i}$\\[4ex]
\hline

	\multirow{2}*{$S_z$} & $\frac{\hbar}{2}$ & $ \ket{+} = \vettore{1\\ 0}$\\[4ex]
%		\cline{2-3}
	& $-\frac{\hbar}{2}$ & $\ket{-} = \vettore{0\\ 1}$\\[4ex]
\hline
	\multirow{2}*{$S_n$} & $\frac{\hbar}{2}$ & $ \ket{+}_n = \vettore{\cos\frac{\theta}{2} e^{-i\frac{\varphi}{2} }\\ \sin \frac{\theta}{2} e^{i\frac{\varphi}{2}   }}$\\[4ex]
%		\cline{2-3}
